	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well">
				<h2>
					<i class="glyphicon glyphicon-th"></i> 店铺颜色
				</h2>
			</div>
			...
			<div class="box-content"id="colorList">
...
<script type="text/javascript">
	$(function(){
		...
		$("#search").on("click",function(){
			...
			$.post("shopcategorycolor/findAllShopCategoryColor.html",$("#form").serialize(),function(data){
				$("#colorList").html(data);
			})
		})
	})
