...
<body class="gray-bg">
											...
											<table class="table table-striped table-hover">
												...
												<tbody>
													<tr v-for="(color,index) in colors">
														...
														<td>{{color.name}}</td>
														<td>
															<button type="button" @click="edit(color.id)" class="btn btn-outline btn-primary">
	...
	<script type="text/javascript">
		new Vue({
			el : "#vue",
			data : {page:null,colors:null},
			mounted : function(){
				spage(1,"color/findAllColor.json",this,"page");
			},
			methods : {
				add : function(){
					layer.open({
						...
						shade : 0.2,
						area : [ "70%", "80%" ],
						content : "color/goColorEdit.html"
					});
				},
				edit : function(id){
					layer.open({
						...
						shade : 0.2,
						area : [ "70%", "80%" ],
						content : "color/goColorEdit.html?id=" + id
					});
				},
				submit : function(){
					spage(1,"color/findAllColor.json",this,"page",$('#color').serialize());
				},
				del : function(index){
					var _this = this;
					var id = _this.colors[index].id;
					...
					layer.confirm("确认删除吗?", {
						...
						$.post("color/deleteColor.json",{id:id},function(data){
