												...
												<thead>
													<tr>
														<td colspan="11">
															...
															<div style="float: left;">全选<a  v-on:click="down" style="cursor: pointer; margin-left: 10px;" class="btn-primary">批量下架</a></div>
				...
				down: function () {
					...
					if (_checkvalue.length > 0) {
						...
						layer.confirm("确认下架吗?", {
							...
							$.post("product/downProduct.json", {id: _checkvalue}, function (data) {
