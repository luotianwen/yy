										...
										<table class="table table-striped table-hover">
											...
											<tr>
												<td colspan="11">
													...
													<div style="float: left;">全选<a  v-on:click="recovery" style="cursor: pointer; margin-left: 10px;" class="btn-primary">批量恢复</a></div>
			...
			recovery: function () {
				...
				if (_checkvalue.length > 0) {
					...
					layer.confirm("确认恢复吗?", {
						...
						$.post("product/recoveryProduct.json", {id: _checkvalue}, function (data) {
