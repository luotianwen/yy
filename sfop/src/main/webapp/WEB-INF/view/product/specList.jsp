...
<body class="gray-bg">
											...
											<table class="table table-striped table-hover">
												...
												<tbody>
													<tr v-for="(spec,index) in specs">
														...
														<td>{{spec.name}}</td>
														<td>
															<button type="button" @click="edit(spec.id)" class="btn btn-outline btn-primary">
	...
	<script type="text/javascript">
		new Vue({
			el : "#vue",
			data : {page:null,specs:null},
			mounted : function(){
				spage(1,"spec/findAllSpec.json",this,"page");
			},
			methods : {
				add : function(){
					layer.open({
				...
				edit : function(id){
					layer.open({
						...
						shade : 0.2,
						area : [ "70%", "80%" ],
						content : "spec/goSpecEdit.html?id=" + id
					});
				},
				submit : function(){
					spage(1,"spec/findAllSpec.json",this,"page",$('#spec').serialize());
				},
				del : function(index){
					var _this = this;
					var id = _this.specs[index].id;
					...
					layer.confirm("确认删除吗?", {
						...
						$.post("spec/deleteSpec.json",{id:id},function(data){
