					...
					<div class="ibox-content">
						...
						<form id="shopbrand" method="post" class="form-horizontal">
							   <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="品牌id" id="b_brand_id" name="b_brand_id" v-bind:value="shopbrand!=null?shopbrand.b_brand_id:''">
									</div>
								</div>
							<div class="hr-line-dashed"></div>
							   <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="提交时间" id="submitime" name="submitime" v-bind:value="shopbrand!=null?shopbrand.submitime:''">
									</div>
								</div>
							<div class="hr-line-dashed"></div>
			...
			methods : {
				submit : function(){
					if (this.check_in()) {
						...
						var url = "shopbrand/saveShopBrand.json";

						if ($("#id").val().trim()!=null&&$("#id").val().trim()!=''&&$("#id").val().trim()!='0') {
							url = "shopbrand/updateShopBrand.json";
						}
						$.post(url, $('#shopbrand').serialize(), function(data) {
