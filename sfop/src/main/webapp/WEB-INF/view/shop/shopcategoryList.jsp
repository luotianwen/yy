...
<body class="gray-bg">
	<div class="wrapper wrapper-content  animated fadeInRight" id="vue">
		<div class="row">
			<div id="user-box" class="col-sm-12">
				<div class="ibox">
					<form id="shopcategory" method="post">
											...
											<table class="table table-striped table-hover">
												...
												<tbody>
													<tr v-for="(shopcategory,index) in shopcategorys">
														<td>{{shopcategory.s_merchants_id}}</td>
														...
														<td>
															<button type="button" @click="edit(shopcategory.s_merchants_id)" class="btn btn-outline btn-primary">
	...
	<script type="text/javascript">
		new Vue({
			el : "#vue",
			data : {page:null,shopcategorys:null},
			mounted : function(){
				spage(1,"shopcategory/findAllShopCategory.json",this,"page");
			},
			methods : {
				add : function(){
					layer.open({
						...
						shade : 0.2,
						area : [ "70%", "80%" ],
						content : "shopcategory/goShopCategoryEdit.html"
					});
				},
				edit : function(id){
					layer.open({
						...
						shade : 0.2,
						area : [ "70%", "80%" ],
						content : "shopcategory/goShopCategoryEdit.html?id=" + id
					});
				},
				submit : function(){
					spage(1,"shopcategory/findAllShopCategory.json",this,"page",$('#shopcategory').serialize());
				},
				del : function(index){
					var _this = this;
					var id = _this.shopcategorys[index].id;
					...
					layer.confirm("确认删除吗?", {
						...
						$.post("shopcategory/deleteShopCategory.json",{id:id},function(data){
							if (data.RESPONSE_STATE == '200') {
								layer.msg('操作成功!', {icon : 1,time : 1 * 1000}, function() {
									_this.shopcategorys.splice(index,1);
								})
							}else{
