                        ...
                        <div class="order_form">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td style="font-size: 12px;">法人身份证(正面)电子版：<img width="200px" height="200px"     v-bind:src="merchantssettled!=null?merchantssettled.corporate_front_card:''"> </td>
                                        <td style="font-size: 12px;">法人身份证(反面)电子版：<img width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.corporate_back_card:''"> </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px;">银行开户许可证电子版：<img width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.bank_image:''"> </td>
                                        <td style="font-size: 12px;" v-if="merchantssettled!=null&&merchantssettled.isThree==1">三证合一电子版：<img width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.threeInOneImage:''"> </td>
                                    </tr>
                                    <tr v-if="merchantssettled!=null&&merchantssettled.isThree==2">
                                        <td style="font-size: 12px;">组织机构代码证电子版：<img width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.organizationImage:''"> </td>
                                        <td style="font-size: 12px;">纳税登记证电子版：<img  width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.taxImage:''"> </td>
                                    </tr>
                                    <tr v-if="merchantssettled!=null&&merchantssettled.isThree==2">
                                        <td style="font-size: 12px;">营业执照副本电子版：<img width="200px" height="200px" v-bind:src="merchantssettled!=null?merchantssettled.licenseImage:''"> </td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    new Vue({
        ...
        mounted: function () {
            ...
            $.post("merchantssettled/findMerchantsSettledById.json?id=" + $("#id").val(), function (data) {
                ...
                data.merchantssettled.taxpayerType=taxpayerType;
