					...
					<div class="ibox-content">
                        <form action="" id="dictionary" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  placeholder="词" id="word"  name="word" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  placeholder="简拼" id="jp"  name="jp" value="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  placeholder="全拼" id="qp"  name="qp" value="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                        <label>
                                            <input type="radio" checked="checked" value="1" name="dic_type" class="radio i-checks"> <i></i> 基本词</label>
                                            &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio"  value="2" name="dic_type" class="radio i-checks"> <i></i> 停止词</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="1" class="form-control" placeholder="权重" name="weight" id="weight" value="1">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
