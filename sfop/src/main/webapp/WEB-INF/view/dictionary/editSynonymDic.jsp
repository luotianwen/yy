				...
				<div class="ibox">
					<div class="ibox-content">
                        <form action="" id="synonymDic" method="post" class="form-horizontal">
                        	<input type="hidden" name="id" id="id" value="${synonymDic.id }">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">同义词</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  placeholder="同义词" id="synonym"  name="synonym" value="${synonymDic.synonym }">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  placeholder="转义词" id="escape"  name="escape" value="${synonymDic.escape }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" disabled placeholder="词" id="word" value="${synonymDic.word }">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
