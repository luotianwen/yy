...
<body class="gray-bg">
			...
			<div id="user-box" class="col-sm-12">
				<div class="ibox">
					<div class="ibox-content">
						<form id="sysappleadpic" method="post" class="form-horizontal">
							<input type="hidden" id="id" name="id" value="${id}"/>
							<div class="form-group">
								<label class="col-sm-2 control-label">图片</label>
								<div class="col-sm-10 col-md-6">
									<input type="hidden"  name="imgUrl"  id="imgUrl"  v-bind:value="sysappleadpic!=null?sysappleadpic.imgUrl:''"/>
									<img    id="logoImg"  v-bind:src="sysappleadpic!=null?sysappleadpic.imgUrl:''"  style="max-width:360px;">
									<br/><br/>
							...
							<div class="hr-line-dashed"></div>
							   <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="序号" id="sort" name="sort" v-bind:value="sysappleadpic!=null?sysappleadpic.sort:''">
									</div>
								</div>
							<div class="hr-line-dashed"></div>
							   <div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control m-b" name="state"  >
											<option value="1" v-bind:selected="sysappleadpic!=null&&sysappleadpic.state==1">发布</option>
											<option value="2" v-bind:selected="sysappleadpic!=null&&sysappleadpic.state==2">下线</option>
										</select>
									</div>
								</div>
							...
							<div class="hr-line-dashed"></div>
							   <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="备注" id="remark" name="remark" v-bind:value="sysappleadpic!=null?sysappleadpic.remark:''">
									</div>
								</div>
							<div class="hr-line-dashed"></div>
	...
	<script type="text/javascript">
		new Vue({
			el : "#vue",
			data : {sysappleadpic:null},
			mounted : function(){
				var _this = this;
				$.post("sysappleadpic/findSysAppleadpicById.json?id="+$("#id").val(),function(data){
					for(var key in data){
			...
			methods : {
				submit : function(){
					if (this.check_in()) {
						...
						var url = "sysappleadpic/saveSysAppleadpic.json";

						if ($("#id").val().trim()!=null&&$("#id").val().trim()!=''&&$("#id").val().trim()!='0') {
							url = "sysappleadpic/updateSysAppleadpic.json";
						}
						$.post(url, $('#sysappleadpic').serialize(), function(data) {
