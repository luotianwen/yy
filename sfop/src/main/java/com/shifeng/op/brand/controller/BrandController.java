package com.shifeng.op.brand.controller;
...
public class BrandController{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/findAllBrandFroOudit")
	@ResponseBody
	public Map<String,Object> findAllBrandFroOudit() throws Exception{
		Map<String,Object> map = new HashMap<String,Object>();
		List<Brand> brands = brandServiceImpl.findAllBrandFroOudit();
		map.put("brands", brands);
		return map;
	}
}
