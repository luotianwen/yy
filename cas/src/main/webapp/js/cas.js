...
head.ready(document, function() {
	...
	head.load("https://apps.bdimg.com/libs/jquery/1.11.3/jquery.min.js", loadjQueryUI);
});

function loadjQueryUI() {
    //head.load("https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js", loadjQueryCookies);
	head.load("https://apps.bdimg.com/libs/jqueryui/1.10.4/jquery-ui.min.js", loadjQueryCookies);
}

function loadjQueryCookies() {
    //head.load("https://cdnjs.cloudflare.com/ajax/libs/jquery-cookie/1.4.1/jquery.cookie.min.js", resourceLoadedSuccessfully);
	head.load("https://apps.bdimg.com/libs/jquery.cookie/1.4.1/jquery.cookie.js", resourceLoadedSuccessfully);
}
