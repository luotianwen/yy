		...
		<div class="ui-dialog-content ui-widget-content" id="js_pay_panel"
			...
			<div>
				<div class="yp-pay-wrap">
					...
					<div class="yp-pay-way" style="background-color: #fff">
						<div class="pay-way-hd">
							<ul class="pay-tab-menu clearfix js_pay_paytype">
								<li class="current" data-pay-type="0"><a href="#">支付宝</a></li>
								<li data-pay-type="1"><a href="#">微信支付</a>
								</li>
						...
						<div class="pay-way-bd alipay clearfix" style="display: block;">
							<div class="pay-way-item">
								...
								<div class="pay-way-main">
									<div class="pay-code">
										...
										<img class="js_alipay_qrcode" style="display: inline;"
											src="zfb.png">
										<p class="code-txt">
											打开支付宝钱包<br>扫一扫继续付款
										</p>
					...
					<div class="yp-pay-fdback" id="pay-timeout" style="display: none">
					...
					<div class="yp-pay-fdback" id="pay-confirm" style="display: none">
						<div class="fdback-result">
...
e.find(".js_btn_alipay").on("click", function (e) {
    ...
    e.preventDefault(), $(this).addClass("current").siblings("li").removeClass("current"), 
    $(this).find(".corner").addClass("corner-right"), 
    $(this).find(".corner-right").removeClass(".corner-right")
