...
public class ZXingCodeDemo {
    ...
    {  
        try  
        {  
            getLogoQRCode("weixin://wxpay/bizpayurl?pr=enZgi47", null, "微信扫描支付");
        }  
        catch (Exception e)  
        {  
            e.printStackTrace();  
    ...
    public static String getLogoQRCode(String qrUrl,HttpServletRequest request,String productName)
    {
        ...
        String filePath = "E:/SFMallWorkspace/sf-pay/src/test/java/com/demo/1.png";  //TODO 
        String content = qrUrl;
        try
        {  
            ZXingCodeDemo zp = new ZXingCodeDemo();
...
// outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            ImageIO.write(image, "png", new File("C:/Users/WinZhong/Desktop/TDC-" + new Date().getTime() + "test.png")); //TODO 
